package io.github.gumbo.launcher;

import io.github.gumbo.launcher.url.JarInJarHandler;
import io.github.gumbo.launcher.url.JarInJarHandlerFactory;
...
//	
	...
	public static final String JETTY_LAUNCHER = "io.github.gumbo.launcher.jetty.Main";
...
//	}
	...
	protected List<URL> getPlugins() {
		String[] paths = System.getProperty("gumbo.plugins", "plugins").trim().split("\\s*:\\s*");
